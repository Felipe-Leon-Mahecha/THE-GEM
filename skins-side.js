...
//
// Nombres de archivo dentro de la carpeta (convencion estándar):
...
//
// La imagen frontal (tienda): skin_[id].png, suelta en la misma carpeta.
//
...
const SKIN_FOLDER_REGISTRY = [
    ...
    { id: 'skin_platino', folder: 'assets/UI/Store/VIP/Bundles/Royal/skin_platino', symmetric: true, drawScale: 1.5 }, // recompensa Camino de Rangos
    { id: 'skin_gran_maestro', folder: 'assets/UI/Stor /* e *//VIP/Bundles/Royal/skin_gran_maestro', symmetric: true, drawScale: 1.6 }, // recompensa Camino de Rangos
    ...
    { id: 'skin_chocolate', folder: 'assets/UI/Store/VIP/Bundles/Food/skin_chocolate', rolling: true, drawScale: 1.4 },
    ...
    { id: 'skin_pancakes', folder: 'assets/UI/Store/VIP/Bundles/Food/skin_pancakes', rolling: true, drawScale: 1.4 },
    { id: 'skin_papas_fritas', folder: 'assets/UI/Store/VIP/Bundles/Food/skin_papas_fritas', rolling: true, drawScale: 1.4 },
    { id: 'skin_pina', folder: 'assets/UI/Store/VIP/Bundles/Food/skin_pina', rolling: true, drawScale: 1.4 },
    ...
    { id: 'skin_cerdo', folder: 'assets/UI/Store/VIP/Bundles/Wild/skin_cerdo', rolling: true, drawScale: 1.4 },
    ...
    // TEMPORADA LEYENDAS
    // ══════════════════════════════════════════════════════
    { id: 'skin_solmerion', folder: 'assets/Imagenes/Temporadas/Temp_Leyendas/Skins/skin_Solmerion', symmetric: true, drawScale: 1.6 },
    { id: 'skin_zherath', folder: 'assets/Imagenes/Temporadas/Temp_Leyendas/Skins/skin_Zherath', symmetric: true, drawScale: 1.6 },
    { id: 'skin_sombra_real', folder: 'assets/Imagenes/Temporadas/Temp_Leyendas/Skins/skin_Sombra_Real', symmetric: true, drawScale: 1.5 },
    { id: 'daxor', folder: 'assets/UI/Store/Skins/Normal/DaxorDemon', symmetric: true, drawScale: 1.5 },

    // ══════════════════════════════════════════════════════
    // SKINS ESPECIALES (tienda normal con imágenes laterales)
    // ══════════════════════════════════════════════════════
    { id: 'kenji', folder: 'assets/UI/Store/Skins/Normal/KenjiEpic', symmetric: true, drawScale: 1.5 },
    { id: 'brifon', folder: 'assets/UI/Store/Skins/Normal/BrifonEpic', symmetric: false, drawScale: 1.5 },

    // ══════════════════════════════════════════════════════
    // PELOTA BÁSICA (rolling — imagen frontal del catálogo)
    // No necesitan carpeta de lados: son esferas simétricas.
    // ══════════════════════════════════════════════════════
    { id: 'cyan', folder: 'assets/UI/Store/Skins/Normal/Balls', rolling: true, drawScale: 1.0 },
    { id: 'red', folder: 'assets/UI/Store/Skins/Normal/Balls', rolling: true, drawScale: 1.0 },
    { id: 'blue', folder: 'assets/UI/Store/Skins/Normal/Balls', rolling: true, drawScale: 1.0 },
    { id: 'yellow', folder: 'assets/UI/Store/Skins/Normal/Balls', rolling: true, drawScale: 1.0 },
    { id: 'orange', folder: 'assets/UI/Store/Skins/Normal/Balls', rolling: true, drawScale: 1.0 },
    { id: 'green', folder: 'assets/UI/Store/Skins/Normal/Balls', rolling: true, drawScale: 1.0 },
    { id: 'purple', folder: 'assets/UI/Store/Skins/Normal/Balls', rolling: true, drawScale: 1.0 },
    { id: 'white', folder: 'assets/UI/Store/Skins/Normal/Balls', rolling: true, drawScale: 1.0 },
    { id: 'black', folder: 'assets/UI/Store/Skins/Normal/Balls', rolling: true, drawScale: 1.0 },

    // ══════════════════════════════════════════════════════
    // PELOTA DONA (rolling — aro de color)
    // ══════════════════════════════════════════════════════
    { id: 'dona_cyan', folder: 'assets/UI/Store/Skins/Normal/Donuts', rolling: true, drawScale: 1.0 },
    { id: 'dona_red', folder: 'assets/UI/Store/Skins/Normal/Donuts', rolling: true, drawScale: 1.0 },
    { id: 'dona_blue', folder: 'assets/UI/Store/Skins/Normal/Donuts', rolling: true, drawScale: 1.0 },
    { id: 'dona_yellow', folder: 'assets/UI/Store/Skins/Normal/Donuts', rolling: true, drawScale: 1.0 },
    { id: 'dona_orange', folder: 'assets/UI/Store/Skins/Normal/Donuts', rolling: true, drawScale: 1.0 },
    { id: 'dona_green', folder: 'assets/UI/Store/Skins/Normal/Donuts', rolling: true, drawScale: 1.0 },
    { id: 'dona_purple', folder: 'assets/UI/Store/Skins/Normal/Donuts', rolling: true, drawScale: 1.0 },
    { id: 'dona_white', folder: 'assets/UI/Store/Skins/Normal/Donuts', rolling: true, drawScale: 1.0 },
    { id: 'dona_black', folder: 'assets/UI/Store/Skins/Normal/Donuts', rolling: true, drawScale: 1.0 },
    ...
    // ══════════════════════════════════════════════════════
    // CONTORNOS (rolling — aro de color sin relleno)
    // No necesitan carpeta de lados.
    // ══════════════════════════════════════════════════════
    { id: 'cool', folder: 'assets/UI/Store/Skins/Normal/Contornos', rolling: true, drawScale: 1.1 },
    { id: 'contorno_red', folder: 'assets/UI/Store/Skins/Normal/Contornos', rolling: true, drawScale: 1.1 },
    { id: 'contorno_purple', folder: 'assets/UI/Store/Skins/Normal/Contornos', rolling: true, drawScale: 1.1 },
    { id: 'contorno_cyan', folder: 'assets/UI/Store/Skins/Normal/Contornos', rolling: true, drawScale: 1.1 },
    { id: 'contorno_orange', folder: 'assets/UI/Store/Skins/Normal/Contornos', rolling: true, drawScale: 1.1 },
    { id: 'contorno_white', folder: 'assets/UI/Store/Skins/Normal/Contornos', rolling: true, drawScale: 1.1 },
    { id: 'contorno_black', folder: 'assets/UI/Store/Skins/Normal/Contornos', rolling: true, drawScale: 1.1 },
    { id: 'frank', folder: 'assets/UI/Store/Skins/Normal/Contornos', rolling: true, drawScale: 1.1 }, // Contorno Amarillo
    { id: 'shield', folder: 'assets/UI/Store/Skins/Normal/Contornos', rolling: true, drawScale: 1.1 }, // Contorno Azul

    // ══════════════════════════════════════════════════════
    // SKINS ESPECIALES — carpeta propia, lados asimétricos
    // ══════════════════════════════════════════════════════
    { id: 'controlador', folder: 'assets/UI/Store/Skins/Normal/Controlador', symmetric: false, drawScale: 1.5 },
    { id: 'metalman', folder: 'assets/UI/Store/Skins/Normal/Metalman', symmetric: false, drawScale: 1.5 },

    // ══════════════════════════════════════════════════════
    // SKINS SUELTAS (tienda, lados asimétricos pendientes de arte)
    // ══════════════════════════════════════════════════════
    { id: 'skin_dama_ruby', folder: 'assets/UI/Store/Skins/Normal/DamaRuby', symmetric: false, drawScale: 1.5 },
    { id: 'skin_diamante_rojo', folder: 'assets/UI/Store/Skins/Normal/DiamanteRojo', symmetric: false, drawScale: 1.5 },
    { id: 'skin_emperador', folder: 'assets/UI/Store/Skins/Normal/Emperador', symmetric: false, drawScale: 1.6 },
    { id: 'skin_guardian_oro', folder: 'assets/UI/Store/Skins/Normal/GuardianOro', symmetric: false, drawScale: 1.6 },
    { id: 'skin_leyenda_ruby', folder: 'assets/UI/Store/Skins/Normal/LeyendaRuby', symmetric: false, drawScale: 1.5 },
    { id: 'skin_lux_void', folder: 'assets/UI/Store/Skins/Normal/LuxVoid', symmetric: false, drawScale: 1.5 },
    { id: 'skin_nucleo_negro', folder: 'assets/UI/Store/Skins/Normal/NucleoNegro', symmetric: false, drawScale: 1.5 },
    { id: 'skin_oraculo', folder: 'assets/UI/Store/Skins/Normal/Oraculo', symmetric: false, drawScale: 1.5 },
    { id: 'skin_pixel_gold', folder: 'assets/UI/Store/Skins/Normal/PixelGold', symmetric: false, drawScale: 1.4 },
];
