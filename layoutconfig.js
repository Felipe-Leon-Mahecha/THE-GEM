// ============================================================
//  THE GEM — layoutconfig.js
//  Capa de LAYOUT: toda la arquitectura geométrica, responsive y
//  posicionamiento espacial del juego (paddings, tamaños, anchos,
//  posiciones de canvas, etc). Los TEXTOS y el TEMA (colores/fuentes)
//  viven en textgemconfig.js (window.GEM_CONFIG), que se carga ANTES
//  que este archivo.
...
//  No toques esto — lee el layout de arriba y lo aplica en CSS.
//
...
function applyConfig() {
    ...
    const t = GEM_LAYOUT.tienda;
    const m = GEM_LAYOUT.menu;
    const mp = m.perfil;
    ...
    ['mobile', 'desktop'].forEach(function (d) {
        ...
        // ── Mute BTN ──
        const mute = GEM_LAYOUT.muteBTN[d];
